...
function moduleNoload() {
  console.log("   ");  
  console.log("[Not a module] load neopixelQuickStart from GitHub view in browser");
  console.log("https://github.com/espruino/EspruinoDocs/tree/master/modules/neopixelQuickStart.js");
  console.log("   ");  
}
exports = {};
exports = moduleNoload;
