...
<span style="color:red">:warning: **Please view the correctly rendered version of this page at https://www.espruino.com/Logging to Google Sheets**. Links, lists, videos, search, and other features will not work correctly when viewed on GitHub.</span>
...
They you need to get your keys into a format that can be used by Espruino.
