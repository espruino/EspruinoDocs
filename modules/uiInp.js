...
, inpDu: function(_,f,x,y,x2,y2,fc,v,vi,b) { // Display (redraws) the updateable part of inp
    ...
    _.dl([vi[0],vi[1],vi[2],vi[3],(m=vi[7])?m(v):v],x,y); }
, inp: function(_,e) { if ((e===_.ef) && !_.t) { // touch event on inp ui element
      _.inpU(_, e, ((_.mu(_.lx-_.dx)<4) && (_.mu(_.ly-_.dy)<4)
        && (_.mu(e[5]-7-_.x)<4) && (_.mu(e[4]+7-_.y)<4)) ? "" : e[9], 1); } }
};
