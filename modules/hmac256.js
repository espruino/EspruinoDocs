/* Copyright (c) 2024 MaBe based on hmac.js from Dominik Enzinger. See the file LICENSE for copying permission. */
function bitwiseOr0x36(b) {return b ^ 0x36; }
function bitwiseOr0x5c(b) {return b ^ 0x5c; }

/// Returns an MAC instance using the given hash. Eg. HMAC(key, require('crypto').SHA2, 64, 32)
