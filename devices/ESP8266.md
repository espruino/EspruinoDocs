...
| `0.40.0.0`        | 115200 |`ESP8266WiFi_0v25` | This comes pre-installed on most AI-thinker modules at the moment, and works well with Espruino ([download firmware](/files/ESP8266_AT25-SDK112-512k.bin)) |
| `1.1.0.0`        | 115200 |`ESP8266WiFi_0v25` | We've tested this firmware on Espruino WiFi and it works fine, however it
is not compatible with 512kB ESP01 modules ([download firmware](/files/ESP8266_AT_1_5_4.zip)) |
