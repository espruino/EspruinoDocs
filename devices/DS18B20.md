...
**Note:** The DS18B20 comes in a cable, SMD, and transistor-style package. We're only covering the cable and transistor package here, but for the SMD one see the [Datasheet](/datasheets/DS18B20.pdf).
