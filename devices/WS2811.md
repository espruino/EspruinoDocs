...
```
  ...
  **Note: It seems that some of the WS2811/WS2812 lights expect signals at different frequencies. If the commands above don't work for you, you should try again with baud set to 6400000 or 1600000 (instead of 3200000).**
