...
Utility
---------------
See the eeprom page (TODO: Link it) for information on adding additional utility functions for converting numbers into arrays or strings to write to the EEPROM.
