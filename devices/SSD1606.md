...
![SSD1606](SSD1606/ssd1606.jpg)

[SSD1606](http://www.solomon-systech.com/en/product/advanced-display/Dot-Matrix_Bistable_Display/ssd1606/) SSD1606 is a CMOS active matrix bistable display driver with controller, that can support a maximum display resolution 128x180. It is used for [e-paper or e-ink displays](https://en.wikipedia.org/wiki/Electronic_paper) like the [GDE021A1](http://smart-prototyping.com/E-ink-E-paper-new-version-display-module-3.3V-2.04-inch-177x72.html) with a resolution of 177x72.
...
| SSD1606 | Notes |
|---------|-------|
| GND     | Ground pin on the SSD1606 has no marking. |
...
Different displays need different times for refreshing the display and for the hardware reset. You can overwrite the defaults (right now 100ms each).
...
For private persons it is not easy to get the SSD1606 separately. The combination of display driver and display is more common and easily purchasable in small amounts for private persons.

* [eBay](http://www.ebay.com/sch/i.html?_nkw=GDE021A1)
