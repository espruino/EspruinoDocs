...
* Hold the button down. After around 6 seconds the screen goes blank and displays some pixellated text (`DFU #V##` which if the DFU version)
...
* Compass on, 12.5Hz - 1.2mA (+0.6mA)
* Compass on, 1.25Hz (`Bangle.setPollInterval(800)`) - 1.0mA (+0.2mA)
